...
csv_file = "output_ipv4_changes_rrc00.csv"  # Replace with the path to your CSV file
...
plt.xlabel('Time')
plt.ylabel('Changes Paths')
plt.title('Top 10 AS Peers by Changes Paths in RRC00 Over 1 Year')
plt.legend()
...
plt.savefig('top_10_changes_paths.png')

# Save the plot as a LaTeX-compatible PGF file
plt.savefig('top_10_changes_paths.pgf', bbox_inches='tight', pad_inches=0)
